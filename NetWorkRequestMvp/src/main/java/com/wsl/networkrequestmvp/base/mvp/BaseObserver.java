...
import com.wsl.networkrequestmvp.base.ApiException;
import com.wsl.networkrequestmvp.base.NetWorkRequestMvpModule;
import com.wsl.networkrequestmvp.utils.NetWorkUtils;
...
public abstract class BaseObserver<T> extends DisposableObserver<T> {
    ...
    public static final int CODE = NetWorkRequestMvpModule.getSUC_CODE();
    ...
    public BaseObserver(BaseView view,boolean showDialog) {
        this.view = view;
    ...
    public void onError(Throwable e) {
        ...
        if (e instanceof HttpException) {
            ...
            if(view!=null){
                ...
                onError("code:"+code +" "+exception.getMessage());
            }
...
//            }
    ...
    private void onException(int unknownError, String message) {
        ...
        if (!NetWorkUtils.isAvailableByPing()) {
            ...
            model.setMessage("网络不可用，请检查网络连接！");
        }
        onExceptions(model.getCode(), model.getMessage());
        if (view != null) {
            view.onErrorCode(model);
        }
    }
